...
def file_row(name: str, parent: str, size: str, date: str, file_type: str = 'other') -> ui.row:
    ...
    with ui.row().classes(f'w-full items-center p-2 rounded hover:bg-white/5 cursor-pointer transition-colors border-b {theme.BORDER} border-opacity-10 gap-4') as row:
        ...
        color = colors.get(file_type.lower(), colors['other'])
